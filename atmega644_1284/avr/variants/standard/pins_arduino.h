...
//                   +--------+
//
#define NUM_DIGITAL_PINS            32  //@kimio_kosaka corrected "24" to "32" (2013.08.15)
#define NUM_ANALOG_INPUTS           8

//#define analogInputToDigitalPin(p)  ((p < 7) ? (p)+24 : -1) // 
#define analogInputToDigitalPin(p)  ((p < 8) ? 31-(p) : -1)   //corrected by @kimio_kosaka (2013.08.15)
